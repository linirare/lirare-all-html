...
function drawHUD() {
  ...
  drawPanel(10, LAYOUT.fieldY + LAYOUT.fieldH - 38, 155, 30, 10, 'rgba(255,255,255,0.58)', null);
  ctx.font = 'bold 12px sans-serif';
  ctx.textAlign = 'left';
  ctx.fillStyle = state.sp > 0 ? THEME.gold : '#c77a40';
  ctx.fillText(`💧 ${state.summonCostCounter} / ⚡ ${state.sp}`, 18, LAYOUT.fieldY + LAYOUT.fieldH - 20);
  ctx.font = '9px sans-serif';
  ctx.fillStyle = THEME.textDim;
  ctx.fillText(`敌 ⚡ ${state.enemySp}`, 18, LAYOUT.fieldY + LAYOUT.fieldH - 10);
